...
var manifest = function(packageName, modulesDirectory){
    ...
    var result;
    try{
        result = (module.exports.require || require)(packageName+'/package');
    }catch(ex){
        ...
        if(fs.existsSync(dir+'/'+file)){
            ...
            }else console.log('File missing:'+(dir+'/'+file), ex);
        }
    }
...
module.exports.require = false; // you may need to pass a require around submodules from the root